...
class MrtBooking extends StatefulWidget {
  const MrtBooking({super.key});

  @override
  State<MrtBooking> createState() => _MrtBookingState();
}

class _MrtBookingState extends State<MrtBooking> {
  // แยกเลือกสายเป็น ต้นทาง/ปลายทาง
  ...
  int estimateFare(int stations) {
    ...
    else if (stations >= 1 && stations <= 2) price = 21;
    else if (stations >= 3 && stations <= 5) price = 28;
    else if (stations >= 6 && stations <= 9) price = 37;
    else if (stations >= 10) price = 42;
    else price = 17;
  ...
  void swapStations() {
    ...
    setState(() {
      ...
      // เคลียร์ถ้าสถานีไม่อยู่ในสายใหม่
  ...
  void _goToReceipt() {
    final bookingId = 'MRT-${DateTime.now().millisecondsSinceEpoch}';
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                Color.fromARGB(255, 133, 18, 18),
                Color.fromARGB(255, 71, 11, 11),
              ],
